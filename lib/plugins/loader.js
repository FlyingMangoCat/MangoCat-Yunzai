      ...
      for (let val of e.message) {
        switch (val.type) {
          ...
          case "at":
            ...
            break;
          case "file":
            /** OneBotv11 的 file 段字段为 file/file_id/file_size,兼容 name/fid 旧字段 */
            e.file = { name: val.name || val.file || "", fid: val.fid || val.file_id || "" };
            break;
        }
      }
    }
