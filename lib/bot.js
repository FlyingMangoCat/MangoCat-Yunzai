...
export default class Yunzai extends EventEmitter {
  ...
  async run() {
    ...
    global.Bot = new Proxy(this, {
      ...
      set: (target, prop, value) => {
        if (prop === "_events") {
          console.log("DEBUG set _events called, new value keys:", Object.keys(value || {}))
        }
      ...
      defineProperty: (target, prop, descriptor) => {
        if (prop === "_events") {
          console.log("DEBUG defineProperty _events called, keys:", Object.keys(descriptor.value || {}))
        }
        this.bots[prop] = descriptor.value
        return true
      },
      deleteProperty: (target, prop) => {
        if (prop === "_events") {
          console.log("DEBUG delete _events called!")
        }
        delete this.bots[prop]
        return true
      },
    })
  ...
  em(name = "", data = {}) {
    if (name.startsWith("message")) {
      ...
      console.log("DEBUG _events:", Object.keys(this._events || {}))
      console.log("DEBUG bots._events:", Object.keys(this.bots?._events || {}))
      console.log("DEBUG target._events:", Object.keys(Object.getPrototypeOf(this)?._events || {}))
    }
