...
export default class Yunzai extends EventEmitter {
  ...
  async run() {
    ...
    global.Bot = new Proxy(this, {
      get: (target, prop) => {
        // _events 必须直接走 target，EventEmitter 内部用 Object.defineProperty / 私有字段操作它
      ...
      set: (target, prop, value) => {
        // _events 必须直接写到 target，EventEmitter 内部用 Object.defineProperty / 私有字段读写它
        if (prop === "_events") {
          target._events = value
          return true
        }
