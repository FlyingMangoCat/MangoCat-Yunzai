...
WORK_DIR="/app/MangoCat-Yunzai"
MIAO_PLUGIN_PATH="/app/MangoCat-Yunzai/plugins/miao-plugin"
XIAOYAO_CVS_PATH="/app/MangoCat-Yunzai/plugins/xiaoyao-cvs-plugin"
LIULIAN_PLUGIN_PATH="/app/MangoCat-Yunzai/plugins/liulian-plugin"

if [[ ! -d "$HOME/.ovo" ]]; then
    mkdir ~/.ovo
fi

echo -e "\n ================ \n ${Info} ${GreenBG} 拉取 MangoCat-Yunzai 更新 ${Font} \n ================ \n"
...
if [[ ! -f "$HOME/.ovo/yunzai.ok" ]]; then
    set -e
    echo -e "\n ================ \n ${Info} ${GreenBG} 更新 MangoCat-Yunzai 运行依赖 ${Font} \n ================ \n"
    pnpm install -P
    touch ~/.ovo/yunzai.ok
    set +e
fi

echo -e "\n ================ \n ${Version} ${BlueBG} MangoCat-Yunzai 版本信息 ${Font} \n ================ \n"
...
if [ -d $LIULIAN_PLUGIN_PATH"/.git" ]; then

    echo -e "\n ================ \n ${Info} ${GreenBG} 拉取 liulian-plugin 插件更新 ${Font} \n ================ \n"

    cd $LIULIAN_PLUGIN_PATH
    ...
    if [[ ! -f "$HOME/.ovo/liulian.ok" ]]; then
        set -e
        echo -e "\n ================ \n ${Info} ${GreenBG} 更新 liulian-plugin 运行依赖 ${Font} \n ================ \n"
    ...
    echo -e "\n ================ \n ${Version} ${BlueBG} liulian-plugin 插件版本信息 ${Font} \n ================ \n"
...
echo -e "\n ================ \n ${Info} ${GreenBG} 启动 MangoCat-Yunzai ${Font} \n ================ \n"
