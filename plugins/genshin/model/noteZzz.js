...
export default class Note extends base {
  ...
  async getData() {
    ...
    if (dailyNote.energy.restore > 0) {
      ...
      ImgData.resinMaxTimeMb2 =
        this.dateTime(maxDate) + moment(maxDate).format("hh:mm");
    ...
    ImgData.sale_state = /Doing/.test(dailyNote.vhs_sale.sale_state)
      ? "正在营业"
      : "未营业";
    ...
    return {
      ...
      ...ImgData,
      dayMb2:
        moment(new Date()).format("yyyy年MM月DD日 HH:mm") +
        " " +
